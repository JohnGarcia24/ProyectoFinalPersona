            ...
            <div className="container-fluid">
                <div className="row p-5 pie">
                    <div className="col-12 col-md-4 align-self-center">
                        <img src="https://firebasestorage.googleapis.com/v0/b/spotyjegc.appspot.com/o/logoTNBHD.png?alt=media&token=064e192d-2283-4910-bc58-b1c05e6ffeb8" alt="foto" className="img-fluid w-100"/>
                    </div>
